...
// Default Values
static const CGFloat kHexGridMainViewRadius = 45.0;
static const CGFloat kHexGridSurroundingViewRadius = 35.0;
static const NSUInteger kHexGridNumberOfViews = 20;
static const CGFloat kHexGridOffsetBetweeenViews = 20.0;
